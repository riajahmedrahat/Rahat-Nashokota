...
try:
	...
	print('[[\x1b[1;92m•\x1b[1;97m] [\x1b[1;96mRahat_Nashokota_xy')
...
def menu(my_name,my_id):
	...
	print('>> 5. Hasil Crack  ')
	print('>> 0. Keluar       ')
	_____Rahat__Nashokota_____ = input('\n>> Pilih : ')
	if _____Rahat__Nashokota_____ in ['1']:
		dump_massal()
	elif _____Rahat__Nashokota_____ in ['2']:
		dump_follower()
	elif _____Rahat__Nashokota_____ in ['3']:
		grup()
	elif _____Rahat__Nashokota_____ in ['4']:
		crack_file()
	elif _____Rahat__Nashokota_____ in ['5']:
		result()
	elif _____Rahat__Nashokota_____ in ['0']:
...
def grup():
	...
	if berr2=='Masuk Facebook':
		...
		Rahat_xy('>> Grup Tidak Di Temukan ')
		time.sleep(0.5)
		grup()
	else:pass
...
#-------------[ CRACK-FROM-FILE ]------------------#
def crack_file():
	try:vin = os.listdir('/sdcard/Rahat-DUMP')
	except FileNotFoundError:
	...
	if len(vin)==0:
		...
		lol = {}
		for isi in vin:
			try:hem = open('/sdcard/Rahat-DUMP/'+isi,'r').readlines()
			except:continue
			cih+=1
			if cih<100:
				nom = ''+str(cih)
		...
		try:geh = lol[geeh]
			...
			time.sleep(3)
			back()
		try:lin = open('/sdcard/Rahat-DUMP/'+geh,'r').read().splitlines()
		except:
...
if __name__=='__main__':
	...
	try:os.mkdir('/sdcard/Rahat-DUMP')
	except:pass
